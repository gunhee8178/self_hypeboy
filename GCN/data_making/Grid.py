...
with open(f'../../dataset/Tree/Tree_grid.pkl', 'wb') as f:
    pickle.dump(data, f, pickle.HIGHEST_PROTOCOL)
'''
with open(f'../../dataset/Tree/Tree_grid.pkl', 'rb') as fin:
...
for size in sizes:
    for version, seed in versions:
        ...
        for col in range(0, size, 4):
            ...
            edge_index[1, col] = 511 + ((col // 3) * 9) + random.randint(0, 9)

            edge_index[0, col + 1] = num1 + 1
            edge_index[1, col + 1] = 511 + ((col // 3) * 9) + random.randint(0, 9)

            edge_index[0, col] = num1 + 2
        ...
        with open(f'../../dataset/Tree/Tree_grid_{size}_{version}.pkl', 'wb') as f:
            pickle.dump(data, f, pickle.HIGHEST_PROTOCOL)
